...
module DataShift
  ...
  module Paperclip
    ...
    class AttachmentLoaderActiveStorage < LoaderBase
      ...
      def perform_load(options = {} )
        ...
        @loading_files_cache = DataShift::ActiveStorage.get_files(file_name, options)
        ...
        loading_files_cache.each do |in_file_name|
          ...
          attachment = create_active_storage_attachment(load_object_class, in_file_name, options)
